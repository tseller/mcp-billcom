...
gcloud run deploy billcom-mcp \
  ...
  --set-secrets="BILLCOM_API_BASE_URL=BILLCOM_API_BASE_URL:latest,BILLCOM_USERNAME=BILLCOM_USERNAME:latest,BILLCOM_PASSWORD=BILLCOM_PASSWORD:latest,BILLCOM_ORGANIZATION_ID=BILLCOM_ORGANIZATION_ID:latest,BILLCOM_DEV_KEY=BILLCOM_DEV_KEY:latest,GOOGLE_CLIENT_ID=GOOGLE_CLIENT_ID:latest,GOOGLE_CLIENT_SECRET=GOOGLE_CLIENT_SECRET:latest,DIVVY_API_TOKEN=mcp-billcom-divvy-api-token:latest"
